...
const BoardPage = () => {
  ...
  const getGradient = (card) => {
    ...
    if (title === "TODO") {
      return {
        background:
          "linear-gradient(65.35deg, rgba(48, 189, 220,0.2) -1.72%, rgba(48, 189, 220) 163.54%)",
      };
    } else if (title === "Doing") {
      return {
        background:
          "linear-gradient(65.35deg, rgba(220, 48, 48,0.2) -1.72%, rgba(220, 48, 48) 163.54%)",
      };
    } else if (title === "Completed") {
      return {
        background:
          "linear-gradient(65.35deg, rgba(48, 220, 86,0.2) -1.72%, rgba(48, 220, 86) 163.54%)",
      };
    } else if (title === "Backlog") {
      return {
        background:
          "linear-gradient(65.35deg, rgba(134, 48, 220,0.1) -1.72%,rgba(134, 48, 220) 163.54%)",
      };
    }
  };
  return (
    <div className="board-container">
      ...
      <Board
        ...
        renderCard={(props, index) => (
          <div key={index} className="kanban-card" style={getGradient(props)}>
            <div>
